            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link custom-underline " href="#">Minhas informações</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link custom-underline " href="index.php?controle=estaleiroController&metodo=logout">Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
